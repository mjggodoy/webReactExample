    ...
    return ( 
        <div className="container">
            ...
            <ul className="list-group">
                <li className="list-group-item"><strong>Project name:</strong> <a href= "http://khaos.uma.es/es/percepcion" target="_blank" rel="noopener noreferrer">"Perception: Semantics in a Platform for Big Data Analysis"</a>
                ...
                <li className="list-group-item"><strong>Project name:</strong> <a href= "http://khaos.uma.es/es/BigData" target="_blank" rel="noopener noreferrer">"A Collaborative Platform for Big Data Aanalysis"</a>
                    <p><strong>Principal Researcher:</strong> José F. Aldana Montes <br/> 
                    <strong>Start Date:</strong> 03/2013<br/> 
                    <strong>End Date:</strong> 03/2017<br/> 
                    <strong>Reference code:</strong> P12-TIC-1519</p>
                </li>
                <li className="list-group-item"><strong>Project name:</strong> <a href= "http://khaos.uma.es/es/TIC-7529" target="_blank" rel="noopener noreferrer">"Towards a Platform for Exploiting and Analyzing Linked Data in the Context of Biology Systems"</a>
                    <p><strong>Principal Researcher:</strong> José F. Aldana Montes <br/> 
                    <strong>Start Date:</strong> 03/2013<br/> 
                    <strong>End Date:</strong> 03/2017<br/> 
                    <strong>Reference code:</strong> TIC-7529</p>
                </li>
                <li className="list-group-item"><strong>Project name:</strong> <a href= "http://khaos.uma.es/es/Bioledge" target="_blank" rel="noopener noreferrer">"Bio Knowledge Extractor and Modeller for Protein Production"</a>
                    <p><strong>Principal Researcher:</strong> José F. Aldana Montes <br/> 
                ...
                <li className="list-group-item"><strong>Project name:</strong> <a href= "http://www.aelid.es/" target="_blank" rel="noopener noreferrer">"Aelid: Spanish Association for Open Linked Data"</a>
                    <p><strong>Principal Researcher:</strong> José F. Aldana Montes <br/> 
                    <strong>Start Date:</strong> 10/2011<br/> 
            ...
            <ul className="list-group">
                <li className="list-group-item">Cristóbal Barba-Gonzaléz, José García-Nieto, Antonio J. Nebro and José F. Aldana-Montes <br />
                    ...
                    <a href="http://dx.doi.org/10.1007/978-3-319-54157-0_2" target="_blank" rel="noopener noreferrer"> doi:10.1007/978-3-319-54157-0_2</a>
                </li>
                <li className="list-group-item">María Jesús García Godoy, Esteban López-Camacho, José García-Nieto, Antonio J. Nebro and José F. Aldana-Montes: <br />
                    ...
                    <a href="http://www.mdpi.com/1420-3049/21/11/1575" target="_blank" rel="noopener noreferrer"> doi:10.3390/molecules21111575</a>
                </li>
                <li className="list-group-item">María Jesús García Godoy, Esteban López-Camacho, Ismael Navas-Delgado and José F. Aldana-Montes: <br />
                    ...
                    <a href="http://dx.doi.org/10.1007/978-3-319-44403-1_25" target="_blank" rel="noopener noreferrer">doi:10.1007/978-3-319-44403-1_25</a>
                 </li>
                <li className="list-group-item"> Cristóbal Barba-González, José García-Nieto, María del Mar Roldán-García, Ismael Navas-Delgado, Antonio J. Nebro and José F. Aldana-Montes<br />
                    ...
                    <a href="https://doi.org/10.1016/j.eswa.2018.08.026" target="_blank" rel="noopener noreferrer">doi:10.1016/j.eswa.2018.08.026</a>
                </li>
                <li className="list-group-item">José García-Nieto, Esteban López-Camacho, María Jesús García-Godoy, Antonio J. Nebro and José F. Aldana-Montes <br />
                    ...
                    <a href="https://doi.org/10.1016/j.swevo.2018.05.007" target="_blank" rel="noopener noreferrer">doi:10.1016/j.swevo.2018.05.007</a>
                 </li>
            </ul>
        </div>
    );
